...
Partial Class sidePanelControl
    ...
    Private Sub InitializeComponent()
        ...
        Button7.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Button7.Location = New Point(1, 773)
        Button7.Name = "Button7"
        Button7.Padding = New Padding(20, 0, 0, 0)
        Button7.Size = New Size(232, 39)
        Button7.TabIndex = 21
        Button7.Text = "User Settings"
        ...
        Button6.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Button6.Location = New Point(1, 710)
        Button6.Name = "Button6"
        Button6.Padding = New Padding(20, 0, 0, 0)
        Button6.Size = New Size(232, 39)
        Button6.TabIndex = 20
        Button6.Text = "Order Logs"
        ...
        Button5.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Button4.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Button3.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Button2.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
