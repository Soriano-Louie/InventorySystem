...
Public Class wholesaleDashboard
    ...
    Private topProducts As New List(Of TopProductInfo)()
    Private selectedProductIndex As Integer = 0
    ...
    Public Sub New()
        ...
        ' POLYMORPHISM: Initialize wholesale-specific data loader
        dataLoader = New WholesaleDashboardDataLoader()
    ...
    ' Chart drawing methods - adapted for wholesale (using SalesReport and wholesaleProducts)
    ...
    Private Sub SetupChartPanel()
        ...
        Dim titleWidth As Integer = 300
        Dim totalWidth As Integer = navWidth + titleWidth + 20
        ...
        lblChartTitle.Location = New Point(startX + navWidth + 20, 15)
    ...
    Private Sub ChartPanel_MouseMove(sender As Object, e As MouseEventArgs)
        ...
        Dim chartHeight As Integer = panel.Height - (margin * 2) - 30
        Dim chartRect As New Rectangle(margin, margin + 30, chartWidth, chartHeight)
        ...
        If e.X >= chartRect.Left AndAlso e.X <= chartRect.Right AndAlso
           e.Y >= chartRect.Top AndAlso e.Y <= chartRect.Bottom Then
            ...
            If closestIndex >= 0 AndAlso minDistance <= 20 Then
    ...
    Private Sub DrawGridAndLabels(g As Graphics, chartRect As Rectangle, minValue As Decimal, maxValue As Decimal)
        ...
        Dim gridPen As New Pen(Color.FromArgb(200, 200, 200), 1)
        ...
        For i As Integer = 0 To chartData.Count - 1
            If i Mod 5 = 0 OrElse i = chartData.Count - 1 Then
                Dim x As Integer = chartRect.Left + (i * chartRect.Width \ (chartData.Count - 1))
    ...
    Private Sub DrawNoDataMessage(g As Graphics, panel As Panel)
        Dim messageFont As New Font("Arial", 18, FontStyle.Bold)
