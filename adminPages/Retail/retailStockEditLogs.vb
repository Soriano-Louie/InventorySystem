    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Using con As New SqlConnection(GetConnectionString())
            ...
            SELECT 
                ...
                rsel.oldQuantity AS 'Old Quantity',
                rsel.newQuantity AS 'New Quantity',
                (rsel.newQuantity - rsel.oldQuantity) AS 'Change',
                rsel.unitType AS 'Unit',
                u.username AS 'Edited By',
                rsel.editReason AS 'Edit Reason'
            FROM retailStockEditLogs rsel
            INNER JOIN retailProducts p ON rsel.retailProductId = p.ProductID
            INNER JOIN Categories c ON p.CategoryID = c.CategoryID
            INNER JOIN Users u ON rsel.editedBy = u.userID
            WHERE rsel.editDate BETWEEN @FromDate AND @ToDate
            ORDER BY rsel.editDate DESC"
