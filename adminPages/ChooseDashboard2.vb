...
Public Class ChooseDashboard2
    ...
    Public Sub New()
        ...
        TableLayoutPanel1.BackColor = Color.FromArgb(79, 51, 40)
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SetRoundedRegion2(chooseTableLayoutPanel1, 30)
    ...
    '    Dim parentPanel As Panel =  ' your panel
